...
export function StarButton({
    ...
    return (
        <>
            <style>{`
        @keyframes star-btn-travel {
          0% { offset-distance: 0%; }
          100% { offset-distance: 100%; }
        }
        .star-btn-light {
          animation: star-btn-travel ${duration}s linear infinite;
        }
        .star-btn-root {
          position: relative;
          z-index: 3;
        ...
        .star-btn-root:hover { transform: scale(1.03); }
        .star-btn-root:active { transform: scale(0.98); }
      `}</style>
            <Link
                href={href}
                ref={ref}
                className={`star-btn-root ${className}`}
                style={{ '--path': 'none' } as CSSProperties}
            >
                <div
                    className="star-btn-light"
                    style={{
                        position: 'absolute',
                        aspectRatio: '1/1',
                        inset: 0,
                ...
                <div
                    ...
                    aria-hidden="true"
                >
                    <StarBackground color={borderColor} />
                </div>
