...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://munshi.pk',
    siteName: 'Munshi',
    images: [{ url: '/branding/og-image.png', width: 1200, height: 630, alt: 'Munshi - WhatsApp Business Operating System' }],
    locale: 'en_US',
    type: 'website',
  },
  twitter: {
  ...
  icons: {
    ...
    other: [
      { url: '/branding/android-chrome-192.png', sizes: '192x192', type: 'image/png' },
      { url: '/branding/android-chrome-512.png', sizes: '512x512', type: 'image/png' },
    ],
  },
}
